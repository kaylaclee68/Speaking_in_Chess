...
# I/O
epochs = 10
out_dir = 'out_chess_llm_q_iteration_legal_target_adversarial_2'
eval_interval = 3
        ...
        if adv_iter % eval_interval == 0 or adv_iter == (num_adversary_steps - 1):
            ...
            if wandb_log:
                wandb.log({
                    ...
                    "adv_mean_trajectory_prob": mean_ptaus,
                    "adv_mean_loss": mean_loss,
                    "adv_winrate": winrate,
                    "adv_drawrate": drawrate,
                    "adv_lossrate": lossrate,
                    "lr": lr,
                })
            adv_num_wins = 0
            adv_num_draws = 0
            ...
            if winrate / (lossrate + 1e-6) > 2:
                ...
                print("sufficient winrate acheived, moving on")
                break
        ...
        if train_iter % eval_interval == 0 or train_iter == (num_train_steps - 1):
            ...
            if wandb_log:
                wandb.log({
                    ...
                    "policy_mean_trajectory_prob": mean_ptaus,
                    "policy_mean_loss": mean_loss,
                    "policy_winrate": winrate,
                    "policy_drawrate": drawrate,
                    "policy_lossrate": lossrate,
                    "lr": lr,
                })
            train_num_wins = 0
            train_num_draws = 0
